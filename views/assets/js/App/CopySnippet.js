...
class CopySnippet {
  ...
  showCodeSnippetToCopy(event) {
    ...
    if (this.currentActiveRelease === event.target) {
      this.currentActiveRelease.classList.remove("badge-primary");
      this.currentActiveRelease.classList.add("badge-secondary");
      this.currentActiveRelease = null;
    ...
    this.currentActiveRelease.classList.remove("badge-secondary");
    this.currentActiveRelease.classList.add("badge-primary");
